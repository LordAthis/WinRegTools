...
function Show-Menu {
    ...
    Write-Host " 5A  Edge WebView2 drasztikus teljes torlese (MS Office/Teams osszeomolhat!)" -ForegroundColor Red
    ...
    Write-Host " 11A Cortana Asszisztens teljes eltavolitasa"
    Write-Host " 11B Copilot es beepitett AI modulok eltavolitasa"
    Write-Host " 11C Edge WebView2 Telemetria es hatter-frissitesek letiltasa"
    ...
    Write-Host " 16B Edge WebView2 Runtime tiszta ujratelepitese, biztositva a telemetria, kovetes tiltva!" -ForegroundColor Green
...
do {
    ...
    switch ($choice.ToUpper()) {
        ...
        "11A" { Run-Script "DisableAndClean-Cortana.ps1" }
        "11B" { Run-Script "DisableAndClean-Copilot.ps1" }
        "11C" { Run-Script "Disable-WebView2Telemetry.ps1" }
        ...
        "16B" { Run-Script "Restore-WebView2Runtime.ps1" }
